...
<div class="view">
    ...
    <div id="sidebar2"
        ...
        <div class="sidebar-item">
            ...
            <div>
                <?php /* <label for="code" class="hide">ID:</label> */ ?>
                <?php /* <input id="index" class="hide input-sidebar"> */ ?>
                <?php /* <input id="id" class="hide input-sidebar"> */ ?>
                ...
                <?php /* <label for="state">Trạng thái:</label>
                ...
                <button id="btn_submit"
                        style="border-radius:0;float: left; margin-top: 10px; font-size: 17px;height: 40px;"><i
                            class="fa fa-check-circle"></i> Thêm vào
                </button>
    ...
    <div id="windows_web" class="windows">
        <div><i class="fa fa-file-image-o" aria-hidden="true"></i> Ảnh sản phẩm</div> 
        <div>
            <div>
                ...
                <?php /* <label>Mô tả sản phẩm:</label>
...
<script>
    ...
    var btn_web = $("<button><i class='fa fa-file-image-o'></i> Ảnh sản phẩm</button>");
...
//                },
    ...
    ProductsListApp.createEvent = function () {
        ...
        function request_filter() {
            ...
            var string_where = pcode_f + pname_f + branch_f + cat_f  + price_f;
