    ...
    <div class="clearfix">
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title">@lang('Tất cả sản phẩm')</p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title">@lang('Bán hôm nay')</p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title">@lang('Tiền nhập hàng hôm nay')</p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title">@lang('Tiền lãi hôm nay')</p>
