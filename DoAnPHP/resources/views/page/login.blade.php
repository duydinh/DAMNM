...
<div>
    <div class="simple-page-wrap">
        <div class="simple-page-logo">
            <a href="#">
                <span><i class="fa fa-shopping-bag"></i></span> <span>@lang('Website quản lý hệ thống cửa hàng kinh doanh LAPTOP')</span>
            </a>
        </div>
        <div class="simple-page-form animated flipInY" id="login-form">
            <h4 class="form-title m-b-xl text-center">@lang('Đăng nhập hệ thống')</h4>
            <form action="#">
                <div class="form-group"><input id="username" type="text"
                                               class="form-control" placeholder="@lang('Tên đăng nhập')">
                </div>
                <div class="form-group">
                    <input id="password" type="password" class="form-control"
                                               placeholder="@lang('Mật khẩu')"></div>
                <button id="btn_login"  type="button" class="btn btn-primary"> @lang('Đăng nhập')</button>
            </form>
        </div>
        <div class="simple-page-footer"><p><a href="#">@lang('')</a></p>
            <p>
                <small>@lang('')</small>
                <a href="#">@lang('')</a></p>
        </div>
...
<div id="messageNotificationErr">
    <div>
        @lang('Sai tài khoản hoặc mật khẩu')
    </div>
</div>
<div id="messageNotificationSucc">
    <div>
        @lang('Đăng nhập thành công ...')
    </div>
</div>
