...
<head>
    ...
    <meta charset="utf-8">
    <title><?php echo app('translator')->get('Đăng nhập'); ?></title>
    <?php /* <meta name="viewport" content="width=device-width, initial-scale=1"> */ ?>
    <?php /* <title><?php echo app('translator')->get('login.title'); ?></title> */ ?>
...
<div>
    <div class="simple-page-wrap">
        <div class="simple-page-logo">
            <a href="#">
                <span><i class="fa fa-shopping-bag"></i></span> <span><?php echo app('translator')->get('Website quản lý hệ thống cửa hàng kinh doanh LAPTOP'); ?></span>
            </a>
        </div>
        <div class="simple-page-form animated flipInY" id="login-form">
            <h4 class="form-title m-b-xl text-center"><?php echo app('translator')->get('Đăng nhập hệ thống'); ?></h4>
            <form action="#">
                <div class="form-group"><input id="username" type="text"
                                               class="form-control" placeholder="<?php echo app('translator')->get('Tên đăng nhập'); ?>">
                </div>
                <div class="form-group">
                    <input id="password" type="password" class="form-control"
                                               placeholder="<?php echo app('translator')->get('Mật khẩu'); ?>"></div>
                <?php /* <div class="form-group m-b-xl">
                    <div class="checkbox checkbox-primary">
                        <input type="checkbox" id="keep_me_logged_in">
                        <label for="keep_me_logged_in"><?php echo app('translator')->get('lang.Keep me signed in'); ?></label></div>
                </div> */ ?>
                <button id="btn_login"  type="button" class="btn btn-primary"> <?php echo app('translator')->get('Đăng nhập'); ?></button>
            </form>
        </div>
        <div class="simple-page-footer"><p><a href="#"><?php echo app('translator')->get(''); ?></a></p>
            <p>
                <small><?php echo app('translator')->get(''); ?></small>
                <a href="#"><?php echo app('translator')->get(''); ?></a></p>
        </div>
    </div>
</div>
...
<div id="messageNotificationErr">
    <div>
        <?php echo app('translator')->get('Sai tài khoản hoặc mật khẩu'); ?>
    </div>
</div>
<div id="messageNotificationSucc">
    <div>
        <?php echo app('translator')->get('Đăng nhập thành công ...'); ?>
    </div>
</div>
