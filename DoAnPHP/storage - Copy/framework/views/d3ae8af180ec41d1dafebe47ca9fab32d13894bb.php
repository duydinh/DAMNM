<div class="view">
    <div id="sidebar" style="float: right;width: 26.5%;margin-left: 1%;margin-right: 0;">
        <div class="sidebar-item">
            <div><?php echo app('translator')->get('Thông tin bán hàng'); ?></div>
            <div>
                <div>
                ...
                <div style="margin-top: 10px;" class="div-sale clearfix">
                    <label class="lable_sale" for="Stienhang"><?php echo app('translator')->get('Tổng tiền hàng'); ?>:</label>
                    <input class="sale-input sale-input-green" id="Stienhang">
                </div>
                <div class="div-sale clearfix">
                    <label class="lable_sale" for="Skhuyenmai"><?php echo app('translator')->get('Tiền khuyến mãi'); ?>:</label>
                    <input class="sale-input" style="border: 1px solid rgba(92, 184, 92,0.3);" id="Skhuyenmai">
                </div>
                <div class="div-sale clearfix">
                    <label class="lable_sale" for="Sthukhac"><?php echo app('translator')->get('Tiền thu khác'); ?>:</label>
                    <input style="border: 1px solid rgba(92, 184, 92,0.3)" class="sale-input" id="Sthukhac">
                </div>
                <div class="div-sale clearfix">
                    <label class="lable_sale" for="Sthanhtoan"><?php echo app('translator')->get('Tổng thanh toán'); ?>:</label>
                    <input class="sale-input" id="Sthanhtoan">
                </div>
                <div class="div-sale clearfix">
                    <label class="lable_sale" for="Skhachthanhtoan"><?php echo app('translator')->get('Khách thanh toán'); ?>:</label>
                    <input style="border: 1px solid rgba(92, 184, 92,0.3)" class="sale-input sale-input-yellow" id="Skhachthanhtoan">
                </div>
                <?php /* <div class="div-sale clearfix">
                    <label class="lable_sale" for="Snolai"><?php echo app('translator')->get('Khách nợ lại'); ?>:</label>
                    <input class="sale-input" id="Snolai">
                </div> */ ?>
                <div>
                    <label for="ghichu"><?php echo app('translator')->get('Ghi chú bán hàng'); ?>:</label>
        ...
        <div style="margin-top: 15px;">
            <button style="font-size: 17px;border-radius: 0;" id="luuhoadon"><i class="fa fa-print"></i>
                <?php echo app('translator')->get('Lưu và in hóa đơn'); ?>
            </button>
        </div>
    </div>
    <div id="content-table" style="float: left;width: 72%;">
        <div class="input-product-top">
            <h2><?php echo app('translator')->get('Bán hàng'); ?></h2>
            ...
            <div class="container-xx" style="margin-right: 0;float: right;">
                <button onclick="location.hash='';SaleApp.setup_custom(false);" id="btn_exit" style="">
                    <i class="fa fa-power-off"></i> <?php echo app('translator')->get('Thoát'); ?>
                </button>
            </div>

            <?php /* <div class="container-xx" style="margin-right: 0;float: right;">
                <button id="dongbo" style=""><i class="fa fa-cloud"></i> <?php echo app('translator')->get('Đồng bộ'); ?></button>
            </div> */ ?>

            <?php /* <div class="container-xx" style="margin-right: 0;float: right;">
                <button id="trahang" style=""><i class="fa fa-undo"></i> <?php echo app('translator')->get('Trả hàng'); ?></button>
            </div> */ ?>
            <?php /* <div class="container-xx" style="margin-right: 0;float: right;">
                <button id="mayquet" style=""><i class="fa fa-keyboard-o"></i> <?php echo app('translator')->get('Bàn phím'); ?></button>
            </div> */ ?>
            <div class="container-xx" style="margin-right: 0;float: right;">
                <button id="btn_clear" onclick="SaleApp.clear();" style="">
                    <i class="fa fa-refresh"></i> <?php echo app('translator')->get('Làm sạch'); ?>
                </button>
            </div>
        </div>
        <div id="table"></div>
        ...
        <div class="grid-data-web">
            <div class="grid-data-web-title">
                <span id="btn-show-web"><i class="fa fa-chevron-down"></i> <?php echo app('translator')->get('Thu hẹp'); ?></span>
            </div>
    ...
    <div id="popthemkhachhang">
        <div>
            <span><?php echo app('translator')->get('Thông tin khách hàng'); ?></span>
        </div>
        <div>
            <div class="clearfix">
            ...
            <div style="margin-top: 10px;text-align: right;width: 100%;float: left;">
                <?php /* <input style="margin-right: 5px;" class="f-left" id="use_point"> */ ?>
                <?php /* <button class="f-left" id="btn_use_point">
...
<script>
    ...
    SaleApp.createUI = function () {
        ...
        txt_timsanpham.jqxComboBox({
            ...
            placeHolder: "<?php echo app('translator')->get('Tìm kiếm sản phẩm'); ?>",
        ...
        txt_timkhachhang.jqxComboBox({
            ...
            showArrow: false,
            valueMember: 'code',
            placeHolder: "<?php echo app('translator')->get('Tìm kiếm khách hàng'); ?>",
            searchMode: 'containsignorecase',
            renderSelectedItem: function (index, item) {
                if (item['value'] !== '') {
        ...
        table.jqxGrid({
            ...
            columns: [
                ...
                {
                    text: '<?php echo app('translator')->get('Mã sản phẩm'); ?>',
                    dataField: 'code',
                    width: '120', editable: false
                }, {
                    text: '<?php echo app('translator')->get('Tên sản phẩm'); ?>',
                    dataField: 'name', editable: false
                }, {
                    text: '<?php echo app('translator')->get('Số lượng'); ?>',
                    dataField: 'number',
                    ...
                    text: '<?php echo app('translator')->get('Tồn'); ?>',
                    dataField: 'number_max',
                    width: '100px',
                    cellsformat: 'd',
                    cellsalign: 'right', align: 'right', editable: false
                }, {
                    text: '<?php echo app('translator')->get('Tiền bán'); ?>',
                    ...
                    text: '<?php echo app('translator')->get('Tổng tiền'); ?>',
                    dataField: 'price',
                    width: '120px',
    ...
    SaleApp.createEvent = function () {
        ...
        function click_remove(args) {
            ...
            var btn_yes = $('<button class="f-right"><?php echo app('translator')->get('Có'); ?></button>');
            var btn_no = $('<button class="f-right" style="margin-left: 5px;"><?php echo app('translator')->get('Không'); ?></button>');
            ...
            popup_xoa.jqxPopover({
                ...
                width: 180,
                height: 80,
                'title': '<?php echo app('translator')->get('Xóa khỏi giỏ hàng'); ?>',
            ...
            if (e.keyCode == 13) {
                if (txt_timsanpham.jqxComboBox('val').trim() != '') {
                    ...
                    if (sp != null) {
                        ...
                        app.notify('<?php echo app('translator')->get('Sản phẩm không có trong kho'); ?>', 'warning');
                        if (timkiem) {
        ...
        input_km.click(function () {
            ...
            popphantram.jqxPopover({
                ...
                width: 170,
                height: 80,
                'title': '<?php echo app('translator')->get('Nhập phần trăm % '); ?>:',
                selector: $(this)
            });
        ...
        //         btn_mayquet.html('<i class="fa fa-qrcode"></i> <?php echo app('translator')->get('Máy quét'); ?>');
        //     } else {
        ...
        //         // btn_mayquet.html('<i class="fa fa-keyboard-o"></i> <?php echo app('translator')->get('Bàn phím'); ?>');
        //     }
        //     setTimeout(function () {
        //         txt_timsanpham.jqxComboBox('val', '');
        //         txt_timsanpham.jqxComboBox('focus');
