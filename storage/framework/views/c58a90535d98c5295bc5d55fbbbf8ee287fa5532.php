    ...
    <div class="clearfix">
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title"><?php echo app('translator')->get('Tất cả sản phẩm'); ?></p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title"><?php echo app('translator')->get('Bán hôm nay'); ?></p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title"><?php echo app('translator')->get('Tiền nhập hàng hôm nay'); ?></p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title"><?php echo app('translator')->get('Tiền lãi hôm nay'); ?></p>
        ...
        <?php /* <div class="box">
            ...
            <div class="box-content">
                <p class="box-title"><?php echo app('translator')->get('Tiền chi trả hôm nay'); ?></p>
    ...
    homeApp.topProducts = function () {
        ...
        function loadproduct_data(index, max) {
            download_data_where(urls.url_apis.upload_image, {
                ...
                var title = $('<div class="title-top" style="height:auto"></div>');
