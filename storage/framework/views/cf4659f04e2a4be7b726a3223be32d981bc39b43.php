...
<script>
    ...
    var btn_filter = $("<button style='margin-left: 5px;'><i class='fa fa-search'></i> Tìm kiếm</button>");
    ...
    BaoCaoBanHangAPP.createData = function () {
        ...
        download_data_where(urls.url_apis.select, {
            ...
            data: " product_logs.product_list AS 'pcode',products_list.name AS 'pname' ,ABS(product_logs.number) AS 'number',product_logs.price_import,product_logs.price,invoices.customer_name,users.name,product_logs.id"
