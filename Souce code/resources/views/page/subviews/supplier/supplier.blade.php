...
<script>
    ...
    supplierApp.createData = function () {
        ...
        download_data_where(urls.url_apis.select, {
            ...
            data: "supplier.id AS 'id',supplier.code AS 'ma',supplier.name AS 'ten',supplier.phone AS 'dt',supplier.email,SUM(invoices.total_price) AS 'tongmua',SUM(invoices.total_price)-SUM(invoices.total_pay) ,supplier.note AS 'ghichu'"
